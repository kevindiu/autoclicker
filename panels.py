...
from widgets import VarTable, PeriodicTaskCardView, DarkScrollbar, make_button
...
class LeftPanel(tk.Frame):
    ...
    def _build_ui(self):
        ...
        make_button(r1, text="載入", width=4, bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.load_config).pack(side="left", padx=1)
        make_button(r1, text="儲存", width=4, bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.save_config).pack(side="left", padx=1)
        make_button(r1, text="+ 新增", width=5, bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_SMALL_BOLD, command=app.create_new_profile).pack(side="left", padx=(1, 8))
        ...
        make_button(r2, text="↻ 重新整理", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, padx=4, command=app.refresh_window_dropdown).pack(side="left", padx=1)
        make_button(r2, text="◎ 定位視窗", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, padx=4, command=app.locate_target_window).pack(side="left", padx=(1, 8))
        ...
        btn_var_add_main = make_button(col_v_btns, text="➔ 加入掛機流程", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, padx=3, pady=1, command=app.add_variable_to_main_steps)
        btn_var_add_main.grid(row=0, column=0, padx=1, pady=1, sticky="nsew")

        make_button(col_v_btns, text="+ 新增變數", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_SMALL_BOLD, padx=3, pady=1, command=app.add_variable_dialog).grid(row=0, column=1, padx=1, pady=1, sticky="nsew")

        make_button(col_v_btns, text="✎ 修改變數", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, padx=3, pady=1, command=app.edit_selected_variable).grid(row=1, column=0, padx=1, pady=1, sticky="nsew")

        make_button(col_v_btns, text="✕ 刪除變數", bg=UITheme.ACCENT_RED, font=UITheme.FONT_SMALL_BOLD, padx=3, pady=1, command=app.delete_selected_variable).grid(row=1, column=1, padx=1, pady=1, sticky="nsew")

        make_button(col_v_btns, text="▲ 上移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, padx=3, pady=1, command=lambda: app.move_variable(-1)).grid(row=2, column=0, padx=1, pady=1, sticky="nsew")

        make_button(col_v_btns, text="▼ 下移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, padx=3, pady=1, command=lambda: app.move_variable(1)).grid(row=2, column=1, padx=1, pady=1, sticky="nsew")
        ...
        make_button(cr_btns, text="+ 新增", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_SMALL_BOLD, pady=1, command=app.add_new_combo).pack(side="left", fill="x", expand=True, padx=(0, 1))
        make_button(cr_btns, text="✎ 改名", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, pady=1, command=app.rename_selected_combo).pack(side="left", fill="x", expand=True, padx=1)
        make_button(cr_btns, text="⎘ 複製", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, pady=1, command=app.duplicate_selected_combo).pack(side="left", fill="x", expand=True, padx=(1, 0))
        ...
        make_button(cr_order, text="▲ 上移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, pady=1, command=lambda: app.move_combo(-1)).pack(side="left", fill="x", expand=True, padx=(0, 1))
        make_button(cr_order, text="▼ 下移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, pady=1, command=lambda: app.move_combo(1)).pack(side="left", fill="x", expand=True, padx=(1, 0))
        ...
        make_button(f_cr_top, text="▶ 試跑組合", bg=UITheme.ACCENT_INDIGO, font=UITheme.FONT_SMALL_BOLD, padx=6, command=app.test_run_current_combo).pack(side="right")
        ...
        btn_combo_add_click = make_button(r_click, text="+ 瞄準取點", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_NORMAL_BOLD, padx=6, command=lambda: app.add_click_action(is_combo=True))
        ...
        make_button(r_click, text="+ 手動", width=5, bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.add_manual_click(is_combo=True)).pack(side="left", padx=(2, 0))
        ...
        make_button(f_k, text="+ 按鍵", bg=UITheme.BTN_GRAY, padx=4, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.add_key_action(is_combo=True)).pack(side="left", fill="x", expand=True)
        ...
        make_button(f_w, text="+ 停頓(s)", bg=UITheme.BTN_GRAY, padx=4, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.add_wait_action(is_combo=True)).pack(side="left", fill="x", expand=True)
        ...
        make_button(f_call, text="+ 呼叫組合", width=7, bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.combo_add_call_action).pack(side="left")
        ...
        make_button(f_var, text="+ 引用變數", width=8, bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.combo_add_variable_action).pack(side="left")
        ...
        make_button(cr_act_ctrl, text="▲ 上移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.move_combo_action(-1)).grid(row=0, column=0, padx=1, pady=1, sticky="nsew")
        make_button(cr_act_ctrl, text="▼ 下移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.move_combo_action(1)).grid(row=0, column=1, padx=1, pady=1, sticky="nsew")
        make_button(cr_act_ctrl, text="▶ 試跑", bg=UITheme.ACCENT_INDIGO, font=UITheme.FONT_SMALL_BOLD, command=app.test_run_selected_combo_action).grid(row=0, column=2, padx=1, pady=1, sticky="nsew")

        make_button(cr_act_ctrl, text="✎ 修改", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.edit_selected_combo_action).grid(row=1, column=0, padx=1, pady=1, sticky="nsew")
        make_button(cr_act_ctrl, text="⎘ 複製", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.duplicate_combo_action).grid(row=1, column=1, padx=1, pady=1, sticky="nsew")
        make_button(cr_act_ctrl, text="✕ 刪除", bg=UITheme.ACCENT_RED, font=UITheme.FONT_SMALL_BOLD, command=app.delete_combo_action).grid(row=1, column=2, padx=1, pady=1, sticky="nsew")
...
class RightPanel(tk.Frame):
    ...
    def _build_ui(self):
        ...
        btn_step_click = make_button(sr_click, text="+ 瞄準取點", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_NORMAL_BOLD, padx=6, command=lambda: app.add_click_action(is_combo=False))
        ...
        make_button(sr_click, text="+ 手動", width=5, bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.add_manual_click(is_combo=False)).pack(side="left", padx=(2, 0))
        ...
        make_button(f_sk, text="+ 按鍵", bg=UITheme.BTN_GRAY, padx=4, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.add_key_action(is_combo=False)).pack(side="left", fill="x", expand=True)
        ...
        make_button(f_sw, text="+ 停頓(s)", bg=UITheme.BTN_GRAY, padx=4, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.add_wait_action(is_combo=False)).pack(side="left", fill="x", expand=True)
        ...
        make_button(f_scall, text="+ 呼叫組合", width=7, bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.step_add_call_combo_action).pack(side="left")
        ...
        make_button(f_svar, text="+ 引用變數", width=8, bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.step_add_variable_action).pack(side="left")
        ...
        self.btn_toggle = make_button(f_btn_wrap, text="▶ 開始循環執行", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_BIG_BTN, command=app.toggle_run)
        ...
        self.btn_main_test_all = make_button(f_seq_hdr, text="▶ 試跑流程", bg=UITheme.ACCENT_INDIGO, font=UITheme.FONT_SMALL_BOLD, padx=4, command=app.test_run_execution_flow)
        ...
        self.btn_main_up = make_button(sr2, text="▲ 上移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.move_main_step(-1))
        self.btn_main_up.grid(row=0, column=0, padx=1, pady=1, sticky="nsew")

        self.btn_main_down = make_button(sr2, text="▼ 下移", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL_BOLD, command=lambda: app.move_main_step(1))
        self.btn_main_down.grid(row=0, column=1, padx=1, pady=1, sticky="nsew")

        self.btn_main_test = make_button(sr2, text="▶ 試跑", bg=UITheme.ACCENT_INDIGO, font=UITheme.FONT_SMALL_BOLD, command=app.test_run_selected_main_step)
        self.btn_main_test.grid(row=0, column=2, padx=1, pady=1, sticky="nsew")

        self.btn_main_edit = make_button(sr2, text="✎ 修改", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.edit_selected_main_step)
        self.btn_main_edit.grid(row=1, column=0, padx=1, pady=1, sticky="nsew")

        self.btn_main_dup = make_button(sr2, text="⎘ 複製", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.duplicate_main_step)
        self.btn_main_dup.grid(row=1, column=1, padx=1, pady=1, sticky="nsew")

        self.btn_main_del = make_button(sr2, text="✕ 刪除", bg=UITheme.ACCENT_RED, font=UITheme.FONT_SMALL_BOLD, command=app.delete_main_step)
        ...
        btn_pt_add_hdr = make_button(f_pt_hdr, text="+ 新增", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_SMALL_BOLD, padx=6, command=app.add_new_periodic_task)
        ...
        make_button(pt_ctrl, text="+ 新增", bg=UITheme.ACCENT_GREEN, font=UITheme.FONT_SMALL_BOLD, command=app.add_new_periodic_task).grid(row=0, column=0, padx=1, pady=1, sticky="nsew")
        make_button(pt_ctrl, text="✎ 修改", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.edit_selected_periodic_task).grid(row=0, column=1, padx=1, pady=1, sticky="nsew")
        make_button(pt_ctrl, text="✓ 開關", bg=UITheme.ACCENT_CYAN, font=UITheme.FONT_SMALL_BOLD, command=app.toggle_selected_periodic_task).grid(row=0, column=2, padx=1, pady=1, sticky="nsew")

        make_button(pt_ctrl, text="▶ 試跑", bg=UITheme.ACCENT_INDIGO, font=UITheme.FONT_SMALL_BOLD, command=app.test_run_selected_periodic_task).grid(row=1, column=0, padx=1, pady=1, sticky="nsew")
        make_button(pt_ctrl, text="⎘ 複製", bg=UITheme.ACCENT_BLUE, font=UITheme.FONT_SMALL_BOLD, command=app.duplicate_selected_periodic_task).grid(row=1, column=1, padx=1, pady=1, sticky="nsew")
        make_button(pt_ctrl, text="✕ 刪除", bg=UITheme.ACCENT_RED, font=UITheme.FONT_SMALL_BOLD, command=app.delete_selected_periodic_task).grid(row=1, column=2, padx=1, pady=1, sticky="nsew")
        ...
        btn_clear_log = make_button(f_log_hdr, text="清空", bg=UITheme.BTN_GRAY, font=UITheme.FONT_SMALL, padx=6, pady=0, command=app.clear_logs)
